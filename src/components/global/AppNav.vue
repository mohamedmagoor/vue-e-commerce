  ...
  <div class="nav-bar">
    <v-app-bar color="#02218f" height="fit-content" absolute>
      <v-container fluid>
        <v-row class="mt-1">
          <v-col cols="3">
            <img style="cursor:pointer" src="../../assets/images/logo.png" alt="" @click="$router.push({name: 'home'})" />
          </v-col>
          <v-col cols="5">
           <div class="position-relative" style="width:90%">
             <input
              ...
              name="navSearch"
              id="navSearch"
              style="width:90%; border-radius: 30px; outline: none;caret-color:black"
              class="py-3 px-5 bg-white"
              placeholder="Search the store"
            />
            <svg style="position:absolute;right:10px;top:50%;transform:translateY(-50%)" data-icon="search" viewBox="0 0 512 512" width="25%" height="50%">
          ...
          <v-col cols="4" class="ps-8">
            <div class="parent d-flex justify-space-between align-center">
              ...
              <div class="wishlists d-flex flex-column align-center">
                ...
                <span class="mt-1" style="color: #ffb547">Wish Lists</span>
              </div>
              <div class="wishlists d-flex flex-column align-center">
                <svg
                ...
                <span class="mt-1" style="color: #ffb547">Sign In</span>
              </div>
              <div
                ...
                @click="openCart"
              >
              <v-badge v-if="cartItems.length" location="right top" :content="cartItems.length" color="#205dc2" offsetX="-14"></v-badge>
                <svg
                  :style="`width: 28px; fill: #ffb547;${$route.name == 'cart-page'?'none':'unset'}`"
                  viewBox="0 0 1024 1024"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                ...
                <span class="mt-1" style="color: #ffb547">Cart</span>
              </div>
            </div>
          </v-col>
        </v-row>
          ...
          <v-col cols="7">
            ...
            >
              <li v-for="category in categories" :key="category.title">
                <router-link :to="{name: 'products-category',
                    params: { category: category.route,title: category.title },}" style="color:white;text-decoration:none;font-size:18px">{{ category.title }}</router-link></li>
