      ...
      <v-row>
        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              class="text-center px-4 d-flex flex-column align-center justify-center"
              height="300"
...
export default {
  data: () => ({
    cards: [
      ...
      {
        title: "fast shipping",
        desc: "Fast and convineint door to door delivery",
      ...
      },
      {
        ...
        desc: "27/7 customer service- We are here and happy to help!",
