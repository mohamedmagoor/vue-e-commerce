<template>
  <div class="checkout">
    <v-container fluid class="pa-0 ma-0">
      <v-row>
        <v-col cols="12" md="6" lg="7" class="order-1 order-md-0 checkout-left">
          <v-card
            style="padding: 60px 40px 0 40px"
            class="w-100"
            color="white"
            elevation="0"
          >
            ...
            <v-card-title
              style="font-weight: 700; white-space: pre-wrap; line-height: 1.2"
              class="mb-4 pa-0"
            >
              Shipping Address
            </v-card-title>
            ...
            <div
              style="gap: 15px"
              class="user-name d-flex mt-5 align-center justify-center"
            >
              <input
                type="text"
                class="pa-3"
            ...
            <div
              style="gap: 15px"
              class="city-parent d-flex mt-5 align-center justify-center"
            >
              <input
                type="text"
                class="pa-3"
            ...
            <v-divider length="100%"></v-divider>
            <v-card-text class="mt-7" style="color: grey; font-size: 16px">
              All rights reserved new-ella-demo
            </v-card-text>
          </v-card>
        </v-col>
          ...
          >
            ...
            >
              <v-badge :content="item.quantity" color="grey-darken-1">
                <img
                  style="border-radius: 7px; border: 1px solid grey"
                  width="50"
                  height="50"
                  :src="item.thumbnail"
                  alt=""
    ...
    <OrderSuccess v-if="dialog" :popup="dialog" @close-popup="dialog = false" />
  </div>
</template>
<script>
